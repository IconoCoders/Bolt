...
/**
 * Class Foxpost_Woo_Parcel_Home_Delivery_Shipping_Method
 */
class Foxpost_Woo_Parcel_Home_Delivery_Shipping_Method extends Foxpost_Woo_Parcel_Shipping_Method {
    ...
    {
        $this->id                 = self::FOXPOST_WOO_PARCEL_HOME_DELIVERY_SHIPPING_METHOD;
        $this->instance_id        = absint($instance_id);
        $this->method_title       = Foxpost_Woo_Parcel::__('Foxpost Home Delivery shipping');
        $this->method_description = Foxpost_Woo_Parcel::__('Foxpost Home Delivery shipping');
    ...
    function init_form_fields()
    {
        $this->instance_form_fields = array(
            'enabled'             => array(
                ...
                'default' => 'no',
                'class'   => 'foxpost_woo_parcel_hd_enabled',
            ),
            'title'               => array(
                ...
                'default'     => Foxpost_Woo_Parcel::__('Foxpost - Home Delivery'),
                'class'       => 'foxpost_woo_parcel_hd_title',
            ),
            'type'                => array(
            ...
            'fee'                 => array(
                ...
                'type'        => 'price',
                'description' => Foxpost_Woo_Parcel::__('What fee do you want to charge for Foxpost home delivery, disregarded if you choose free. Leave blank to disable.'),
                'default'     => '100',
                'desc_tip'    => true,
                'placeholder' => wc_format_localized_price(0),
                'class'       => 'foxpost_woo_parcel_hd_fee',
            ),
            'free_fee'            => array(
                ...
                'desc_tip'    => true,
                'placeholder' => wc_format_localized_price(0),
                'class'       => 'foxpost_woo_parcel_hd_free_fee',
            ),
            ...
            'seller_own_data'     => array(
                ...
                'description' => Foxpost_Woo_Parcel::__('This remark will be placed into Foxpost export.'),
                'default'     => '',
                'desc_tip'    => true,
            ),
        );
